...
export default function AdminFAQ() {
  ...
  const handleDelete = async (id: string) => {
    ...
    // Confirmation handled in button onClick
            ...
            <div className="p-6 flex-1 flex flex-col">
              ...
              <div className="mt-6">
                <button
                  ...
                  disabled={submitting}
                  className="w-full bg-[var(--primary-color)] hover:bg-[var(--primary-dark)] disabled:bg-neutral-400 disabled:cursor-not-allowed text-white px-4 py-2 rounded font-medium transition-colors flex items-center justify-center">
                  {submitting ? (
                    <>
                        ...
                        <td className="p-4 align-middle border border-neutral-200">
                          <div className="flex items-center gap-2">
                            <button
                              ...
                              disabled={submitting}
                              className="p-1.5 bg-[var(--primary-color)] hover:bg-[var(--primary-dark)] disabled:bg-neutral-400 disabled:cursor-not-allowed text-white rounded transition-colors"
                              title="Edit">
                              <svg
                                width="14"
                                height="14"
                            ...
                            <button
                              ...
                              disabled={submitting}
                              className="p-2 bg-red-600 hover:bg-red-700 disabled:bg-neutral-400 disabled:cursor-not-allowed text-white rounded transition-colors cursor-pointer ml-2"
                              title="Delete">
                              <svg
                                width="16"
                                height="16"
