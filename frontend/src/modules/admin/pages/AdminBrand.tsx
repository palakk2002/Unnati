...
export default function AdminBrand() {
  ...
  const handleAddBrand = async () => {
    ...
    try {
      ...
      if (brandImageFile) {
        const imageResult = await uploadImage(brandImageFile, "Ecommerce/brands");
                      ...
                      <td className="px-4 sm:px-6 py-3">
                        <div className="flex items-center gap-2">
                          <button
                            ...
                            className="p-1.5 bg-[var(--primary-color)]/10 hover:bg-[var(--primary-color)]/20 text-[var(--primary-color)] rounded transition-colors"
                            title="Edit">
                            <svg
                              width="16"
                              height="16"
