    ...
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-0">
        ...
        <div className="text-sm text-neutral-600">
          <span className="text-[var(--primary-color)] hover:text-[var(--primary-dark)] cursor-pointer">Home</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 border border-neutral-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[var(--primary-color)] focus:border-[var(--primary-color)]"
            />
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
        ...
        <div className="lg:col-span-2 bg-white rounded-lg shadow-sm border border-neutral-200 overflow-hidden">
          ...
          {selectedSeller && (
            <div className="p-4 sm:p-6 border-t border-neutral-200 bg-[var(--primary-color)]/5">
                ...
                {filteredSellers.map((seller) => (
                  <div
                    ...
                    className={`p-4 cursor-pointer transition-colors ${selectedSeller?._id === seller._id
                      ? 'bg-[var(--primary-color)]/5 border-l-4 border-[var(--primary-color)]'
                      : 'hover:bg-neutral-50'
                      }`}
                  >
