        ...
        <div className="pb-24 md:pb-8 bg-white min-h-screen">
            ...
            <div className="px-4 md:px-6 lg:px-8 py-6 max-w-3xl mx-auto">
                ...
                <div className="text-center mb-8">
                    ...
                    <h2 className="text-3xl font-bold text-neutral-900 mb-2">Ecommerce</h2>
                ...
                <div className="mb-8">
                    <h3 className="text-lg font-bold text-neutral-900 mb-3 flex items-center gap-2">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-[var(--customer-primary-dark)]">
                    ...
                    <p className="text-sm text-neutral-700 leading-relaxed">
                        At Ecommerce, we're committed to revolutionizing the way you shop and receive your products.
                ...
                <div className="mb-8">
                    ...
                    <p className="text-sm text-neutral-700 leading-relaxed mb-4">
                        Ecommerce is a comprehensive e-commerce platform that connects customers with a wide range
                        of products across multiple categories including groceries, fashion, electronics, pharmacy,
                        and much more.
                    </p>
                    <div className="grid grid-cols-2 gap-3">
                        <div className="bg-[var(--customer-primary-alpha-10)] rounded-lg p-3 border border-teal-100">
                            <div className="text-2xl font-bold text-[var(--customer-primary-dark)] mb-1">10K+</div>
                            <div className="text-xs text-neutral-700">Products</div>
                        </div>
                        <div className="bg-[var(--customer-primary-alpha-10)] rounded-lg p-3 border border-teal-100">
                            <div className="text-2xl font-bold text-[var(--customer-primary-dark)] mb-1">500+</div>
                            <div className="text-xs text-neutral-700">Sellers</div>
                        </div>
                        <div className="bg-[var(--customer-primary-alpha-10)] rounded-lg p-3 border border-teal-100">
                            <div className="text-2xl font-bold text-[var(--customer-primary-dark)] mb-1">50K+</div>
                            <div className="text-xs text-neutral-700">Happy Customers</div>
                        </div>
                        <div className="bg-[var(--customer-primary-alpha-10)] rounded-lg p-3 border border-teal-100">
                            <div className="text-2xl font-bold text-[var(--customer-primary-dark)] mb-1">24/7</div>
                ...
                <div className="mb-8">
                    ...
                    <div className="space-y-3">
                        <div className="flex gap-3">
                            <div className="flex-shrink-0 w-8 h-8 rounded-full bg-[var(--customer-primary-alpha-20)] flex items-center justify-center">
                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-[var(--customer-primary-dark)]">
                ...
                <div className="bg-gradient-to-br from-teal-50 to-teal-100 rounded-2xl p-6 border border-teal-200">
                    ...
                    <div className="space-y-3">
                        <div className="flex items-center gap-3 text-sm">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-[var(--customer-primary-dark)] flex-shrink-0">
                                <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                <polyline points="22,6 12,13 2,6" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                            </svg>
                            <span className="text-neutral-700">support@Ecommerce.com</span>
                        </div>
                        <div className="flex items-center gap-3 text-sm">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-[var(--customer-primary-dark)] flex-shrink-0">
                ...
                <div className="mt-8 text-center">
                    ...
                    <p className="text-xs text-neutral-500 mt-1">© 2024 Ecommerce. All rights reserved.</p>
                </div>
            </div>
        </div>
    );
