                ...
                <div className="px-4 pb-4">
                    <div className="relative">
                        <input
                            ...
                            className="w-full bg-gray-100 border-none rounded-lg px-4 py-3 pl-10 text-base focus:ring-2 focus:ring-[var(--primary-color)]/20 outline-none transition-all"
                            value={searchQuery}
