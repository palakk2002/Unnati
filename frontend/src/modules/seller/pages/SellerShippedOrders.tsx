...
export default function SellerShippedOrders() {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      case 'Shipped': return 'bg-[var(--primary-alpha-20)] text-[var(--primary-darker)] border border-purple-200';
  ...
  return (
    <motion.div className="space-y-6" initial="hidden" animate="visible" variants={containerVariants}>
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4 bg-white p-4 rounded-xl shadow-sm border border-neutral-200">
        <div>
          <h1 className="text-2xl font-bold text-neutral-900 tracking-tight">Shipped Orders</h1>
