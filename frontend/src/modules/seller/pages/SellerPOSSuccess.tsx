...
import { verifyPOSPayment } from "../../../services/api/orderService";
import { useToast } from "../../../context/ToastContext";

export default function SellerPOSSuccess() {
    ...
    (async () => {
      try {
        ...
        if (response.success) {
          ...
          localStorage.removeItem("seller_pos_bills");
          localStorage.removeItem("seller_pos_active_bill");
        } else {
          setStatus("error");
