        ...
        <div className="flex flex-col h-full min-h-screen bg-neutral-50">
            ...
            <div className="bg-white border-b border-neutral-200 px-4 sm:px-6 py-4">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    ...
                    <div className="flex items-center gap-2 text-sm">
                        <Link to="/seller" className="text-[var(--primary-dark)] hover:text-[var(--primary-darker)]">
                            Home
                        </Link>
            ...
            <div className="flex-1 p-4 sm:p-6">
                <div className="bg-white rounded-lg shadow-sm border border-neutral-200 flex flex-col">
                    {/* Section Header - seller Banner */}
                    <div className="bg-[var(--primary-dark)] text-white px-4 sm:px-6 py-3 rounded-t-lg">
                    ...
                    <div className="p-4 flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 border-b border-neutral-100">
                        ...
                        <div className="flex flex-col sm:flex-row gap-3 flex-1">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        className="pl-10 pr-3 py-2 bg-white border border-neutral-300 rounded text-sm focus:ring-1 focus:ring-[var(--primary-color)] focus:outline-none w-full sm:w-64"
                                        readOnly
                                    />
                                    <svg
                                        width="16"
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <select
                                    ...
                                    className="px-3 py-2 bg-white border border-neutral-300 rounded text-sm focus:ring-1 focus:ring-[var(--primary-color)] focus:outline-none cursor-pointer"
                                >
                        ...
                        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
                            ...
                            {/* Export Button */}
                                ...
                                className="bg-[var(--primary-dark)] hover:bg-[var(--primary-darker)] text-white px-3 py-1.5 rounded text-sm font-medium flex items-center gap-1 transition-colors"
                            >
                            ...
                            <div className="relative">
                                ...
                                <input
                                    type="text"
                                    className="pl-14 pr-3 py-1.5 bg-neutral-100 border-none rounded text-sm focus:ring-1 focus:ring-[var(--primary-color)] w-full sm:w-48"
                                    value={searchTerm}
                                        ...
                                        <tr key={index} className="hover:bg-neutral-50">
                                            ...
                                            <td className="p-4 border border-neutral-200 text-sm text-neutral-900">
                                                <button
                                                    ...
                                                    className="text-[var(--primary-dark)] hover:text-[var(--primary-darker)] text-xs font-medium transition-colors"
                                                >
                                                    View
                                                </button>
                                            </td>
                    ...
                    <div className="p-4 border-t border-neutral-100 flex flex-col sm:flex-row justify-between items-center gap-4">
                        ...
                        <div className="flex items-center gap-2">
                            <button
                                ...
                                className="w-8 h-8 flex items-center justify-center border border-[var(--primary-alpha-40)] rounded hover:bg-[var(--primary-alpha-10)] disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                            >
                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
