...
import { getAllSuppliers, createSupplier, Supplier } from '../../../services/api/seller/supplierService';
import { useToast } from '../../../context/ToastContext';

const SellerPOSSuppliers = () => {
            ...
            <div className="bg-white shadow-sm">
                <div className="p-4 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <h1 className="text-xl font-bold">Supplier Khata</h1>
                    </div>
                ...
                {loading && suppliers.length === 0 ? (
                    ...
                    <div className="bg-white md:rounded-2xl md:shadow-sm divide-y divide-gray-100 overflow-hidden border border-gray-100">
                        {suppliers.map(supplier => (
                            <div
                                key={supplier._id}
                                onClick={() => navigate(`/seller/pos/suppliers/${supplier._id}`)}
...
export default SellerPOSSuppliers;
