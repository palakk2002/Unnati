    ...
    const fetchOrders = async () => {
      ...
      try {
        const params: GetOrdersParams = {
          ...
          status: 'Pending' // Hardcoded for this page as per admin pattern
        };
  ...
  return (
    ...
    >
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4 bg-white p-4 rounded-xl shadow-sm border border-neutral-200">
        <div>
          <h1 className="text-2xl font-bold text-neutral-900 tracking-tight">Pending Orders</h1>
          <p className="text-sm text-neutral-500 mt-1">View and manage pending customer orders</p>
        </div>
                  ...
                  <tr>
                    <td colSpan={6} className="px-6 py-12 text-center">
                       <div className="flex flex-col items-center justify-center">
                        ...
                        <h3 className="text-lg font-medium text-neutral-900">No pending orders</h3>
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getStatusColor(order.status)}`}>
                          <span className="w-1.5 h-1.5 rounded-full mr-1.5 bg-yellow-500"></span>
                          {order.status}
                        </span>
                      </td>
