                        ...
                        <div className="flex flex-wrap items-center gap-3">
                            <div className="flex items-center gap-2">
                                ...
                                <input
                                    ...
                                    className="px-3 py-1.5 bg-white border border-neutral-300 rounded text-sm focus:ring-1 focus:ring-[var(--primary-color)] focus:outline-none"
                                />
                            </div>
                            <div className="flex items-center gap-2">
                            ...
                            <button
                                ...
                                className="px-4 py-1.5 bg-neutral-700 hover:bg-neutral-800 text-white text-sm font-medium rounded transition-colors shadow-sm"
                            >
                                Clear
                            </button>
                        </div>
                                            ...
                                            <tr key={index} className="hover:bg-neutral-50">
                                                <td className="p-4 border border-neutral-200 text-sm">
                                                    <Link
                                                        ...
                                                        className="text-[var(--primary-dark)] hover:text-[var(--primary-darker)] font-medium hover:underline"
                                                    >
                                                        {report.orderId}
                                                    </Link>
                                                </td>
                                ...
                                return (
                                    <button
                                        ...
                                        className={`w-8 h-8 flex items-center justify-center border rounded transition-colors ${currentPage === pageNum
                                                ...
                                                : 'border-[var(--primary-alpha-40)] hover:bg-[var(--primary-alpha-10)] text-neutral-900'
                                            }`}
                                    >
                                        {pageNum}
                                    </button>
