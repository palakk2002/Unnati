    ...
    <div className="bg-white rounded-xl shadow-lg border border-neutral-200 p-2 sm:p-3 md:p-4 hover:shadow-xl transition-shadow duration-300">
      ...
      >
        ...
        >
          ...
          {/* Area Fill with Gradient - Very Light seller */}
          <path
            d={areaPath}
        ...
        {hoveredIndex !== null && tooltipPosition && (
          ...
          >
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-neutral-700 font-semibold">Orders: <span className="text-[var(--primary-dark)] font-bold">{data[hoveredIndex]?.value}</span></span>
            </div>
          </div>
        )}
        ...
        {/* Zoom Indicator */}
        {zoom > 1 && (
          <div className="absolute top-2 right-2 bg-[var(--primary-dark)] text-white text-xs px-2 py-1 rounded-full font-medium">
            {Math.round(zoom * 100)}%
          </div>
        )}
      </div>
